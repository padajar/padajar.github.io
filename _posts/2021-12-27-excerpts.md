...
The Boston Opera House is fairly close (10 minutes from campus via the Red Line) and fairly cheap (Hadestown tickets were only $60, and many shows you can get tickets for ~$40), which means I’ve seen a good handful of musicals while in Boston — [Phantom of the Opera](https://mitadmissions.org/blogs/entry/the-swing-of-things/) (with [Nisha](https://mitadmissions.org/blogs/author/ndevasia/) freshman fall!), Aladdin, and Book of Mormon! Next summer, Wicked⁠[02](https://mitadmissions.org/blogs/entry/excerpts/#annotation-2) is coming to town, and COVID permitting, would love to see that c:
